...
export default function ChatPage() {
  ...
  const handleSendMessage = async (content: string) => {
    ...
    if (conversationState === 'start') {
      ...
      // Changed this to a system message
      await systemReplyToUser("On it! Let me connect with Sharkninja's support system for you.");
  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-49px)] bg-white">
